...
public class BoardScreen extends JPanel{
    ...
    public void setUpPlayers(){
		...
		if(0 < returnMaxPlayers())getPlayers().get(0).setPlayerColor(Color.green);
		if(1 < returnMaxPlayers())getPlayers().get(1).setPlayerColor(Color.blue);
		if(2 < returnMaxPlayers())getPlayers().get(2).setPlayerColor(Color.red);
