...
public class BoardScreen extends JPanel {
    ...
    public BoardScreen(MainWindow mw) {
        ...
        BoxLayout boxLayout = new BoxLayout(stats, BoxLayout.X_AXIS);

        stats.setLayout(boxLayout);
        add(stats);
    ...
    private ActionListener Accion() {
        return new ActionListener() {
            ...
            private void PosicionJugadores() {
