...
public class PlayerSelectScreen extends JPanel {
    ...
    public PlayerSelectScreen(MainWindow mw) {
        ...
        add(uc);
        String jugador1 = "1 Player(Default)";
        String jugador2 = "2 Players";
        String jugador3 = "3 Players";

        //set up radio buttons
        opt1 = new JRadioButton(jugador1);
        opt1.setSelected(true);

        opt2 = new JRadioButton(jugador2);

        opt3 = new JRadioButton(jugador3);
