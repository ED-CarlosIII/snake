...
public class PlayerSelectScreen extends JPanel {
    ...
    public PlayerSelectScreen(MainWindow mw) {
        ...
        ActionListener actionListenerOptions = new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                playerOptions();
            }
        };

        opt1.addActionListener(actionListenerOptions);
        opt2.addActionListener(actionListenerOptions);

        opt3.addActionListener(actionListenerOptions);
