...
/**
 * Generates the Player Select Screen.
...
public class PlayerSelectScreen extends JPanel {
    ...
    public PlayerSelectScreen(MainWindow mw) {
        ...
        JLabel mess = new JLabel("Select " + text + ": ");
        add(mess);

        JLabel uc = new JLabel("Default: 1" + text);
        add(uc);

        //set up radio buttons
        opt1 = new JRadioButton("1 " + text + "(Default)");
        opt1.setSelected(true);

        opt2 = new JRadioButton("2 " + text + "s");
        opt3 = new JRadioButton("3 " + text + "s");
