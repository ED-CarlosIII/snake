...
public class PlayerSelectScreen extends JPanel {
    ...
    public PlayerSelectScreen(MainWindow mw) {
        ...
        add(opt2);
        add(opt3);
        ActionListener playerOptions = new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                playerOptions();
            }
        };

        opt1.addActionListener(playerOptions);
        opt2.addActionListener(playerOptions);

        opt3.addActionListener(playerOptions);

        go = new JButton("Customize Board");
        quit = new JButton("Back");
        ActionListener goButton = new ActionListener() {
            public void actionPerformed(ActionEvent event) {
        ...
        quit.addActionListener(quitButton);
