...
public class PlayerSelectScreen extends JPanel {
    ...
    public PlayerSelectScreen(MainWindow mw) {
        ...
        add(mess);
        String default1player = "Default: 1Player";

        JLabel uc = new JLabel(default1player);
        add(uc);
        ...
        BotonRadialListener(opt1);
        BotonRadialListener(opt2);
        BotonRadialListener(opt3);
    ...
    public void BotonRadialListener(JRadioButton botonRadial) {
