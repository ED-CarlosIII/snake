...
public class PlayerSelectScreen extends JPanel {
    ...
    public PlayerSelectScreen(MainWindow mw) {
        ...
        ActionListener accionEscuchar = new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                playerOptions();
            }
        };

        opt1.addActionListener(accionEscuchar);
        opt2.addActionListener(accionEscuchar);
        opt3.addActionListener(accionEscuchar);

        go = new JButton("Customize Board");
        quit = new JButton("Back");
        ActionListener adelante = new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                goButtonActionListener();
            }
        };

        go.addActionListener(adelante);
