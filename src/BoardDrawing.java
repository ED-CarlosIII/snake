...
public class BoardDrawing extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        drawBoard(g2d, cellWidth, cellHeight);
    ...
    private void drawBoard(Graphics2D g2d, int cellWidth, int cellHeight) {
    ...
    private void createCells(int xOffset, int cellWidth, int yOffset, int cellHeight) {
        if (cells.isEmpty()) {
            for (int i = 0; i < row; i++) {
                for (int j = 0; j < col; j++) {
