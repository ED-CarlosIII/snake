...
public class BoardDrawing extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        drawCellsAndNumbers(g2d);       //llamada al nuevo metodo (parametro: variable g2d de tipo Graphics2D)
        drawSnakesAndLadders(g2d);     //llamada al nuevo metodo  
    }
    ...
    public void drawCellsAndNumbers(Graphics2D g2d) {
        ...
        //variables añadidas para que no de problemas
        int width = getWidth();
        int height = getHeight();
