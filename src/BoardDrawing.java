...
public class BoardDrawing extends JPanel {
        ...
        for (Rectangle cell : cells) {
            ...
            for (int pl = 0; pl < bs.maxPlayers; pl++) {
                if (bs.players.get(pl).getPosition() == cellnos[i]) {
                    positionColour(g2d, pl, cell, cellWidth, cellHeight);
                }
            }
    ...
    private void positionColour(Graphics2D g2d, int pl, Rectangle cell, int cellWidth, int cellHeight) {
    ...
    private void blueColourSelect(Graphics2D g2d) {
        g2d.setColor(BLUE);
    }
