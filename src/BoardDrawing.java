...
public class BoardDrawing extends JPanel {
    ...
    BoardScreen bs; //Variable tipo "Tablero"
    //ArrayList<Portal> portals;
    //ArrayList<Player> players;

    /**
     *
     * @param row //Variable "Fila"
     * @param col //Variable "Columna"
     * @param bs //Variable tipo "Tablero"
     */
    ...
    /*
    *
    *@param g Pinta la sucesión de puntos, que a su vez crean una línea y crea celdas en dicho tablero.
    *
    */
    ...
    /**
     *
     * @param pnos Recorre las posiciones del objeto y devulve la posición
     * @return
     */
     ...
     *
     * @param a 
     * @param pnos  Modifica la posicion en la que se encuentra en ese momento el objeto.
     */
