...
public class BoardDrawing extends JPanel {
    ...
    /**
     * CLASE BOARDDRAWING, DIBUJA LOS ELEMENTOS EN PANTALLA
     */
    int b = 0;
    int row = 8;
    int col = 8;
    ...
    public void paintComponent(Graphics g) {
        ...
        crear_Celdas(xOffset, cellWidth, yOffset, cellHeight);
        ...
        for (Rectangle cell : cells) {
            ...
            Dibujar_player_position(i, g2d, cell, cellWidth, cellHeight);
            i++;
        }

        Dibujar_serpientes_escaleras(g2d);

    }

    private void colorAzul(Graphics2D g2d) {
        g2d.setColor(Color.BLUE);
        for (Rectangle cell : cells) {
            g2d.draw(cell);
        }
    ...
    private void colorBlanco(Graphics2D g2d) {
    ...
    private void crear_Celdas(int xOffset, int cellWidth, int yOffset, int cellHeight) {
        if (cells.isEmpty()) {
            for (int i = 0; i < row; i++) {
                for (int j = 0; j < col; j++) {
    ...
    private void Dibujar_player_position(int i, Graphics2D g2d, Rectangle cell, int cellWidth, int cellHeight) {
    ...
    private void Dibujar_serpientes_escaleras(Graphics2D g2d) {
     ...
     */
    /**
     * PARAMETROS PARA SELECCIONARR JUGADOR:
     * 
     * @param a
     * @param pnos
     */
