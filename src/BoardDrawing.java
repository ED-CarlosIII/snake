...
public class BoardDrawing extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        pintarCeldasYNumeros(g2d, cellWidth, cellHeight);
        //Drawing snakes and ladders
        pintarSerpientesYEscaleras(g2d);
    }

    private void pintarCeldasYNumeros(Graphics2D g2d, int cellWidth, int cellHeight) {
        g2d.setColor(Color.BLUE);
    ...
    private void pintarSerpientesYEscaleras(Graphics2D g2d) {
