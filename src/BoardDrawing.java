...
public class BoardDrawing extends JPanel {
   ...
   */
    public void paintComponent(Graphics g) {
        ...
        creaCeldas(xOffset, cellWidth, yOffset, cellHeight, g2d);

        //may have to modify program based on number of players
        dibujaCeldasYNumeros(g2d, cellWidth, cellHeight);
        ...
        for (Rectangle cell : cells) {
            ...
            for (int pl = 0; pl < bs.maxPlayers; pl++) {
                if (bs.players.get(pl).getPosition() == cellnos[i]) {                         
                    cambiaColorJugador(g2d, pl, cell, cellWidth, cellHeight);
                }
            }
    ...
    private void dibujaSnakesYLadders(Graphics2D g2d) {
