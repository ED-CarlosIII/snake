...
public class BoardDrawing extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        ifCellsEmpty(xOffset, cellWidth, yOffset, cellHeight);
        ...
        for (Rectangle cell : cells) {
            ...
            if (cellnos[i] == row * col - 1) {
                colorPlayerPos(i, g2d, cell, cellWidth, cellHeight);
            }
            i++;
        }
    ...
    private void colorPlayerPos(int i, Graphics2D g2d, Rectangle cell, int cellWidth, int cellHeight) {
    ...
    private void ifCellsEmpty(int xOffset, int cellWidth, int yOffset, int cellHeight) {
        if (cells.isEmpty()) {
            for (int i = 0; i < row; i++) {
                for (int j = 0; j < col; j++) {
